...
import 'telas/fornecedores_medicamentos.dart' as fornecedores;
import 'telas/produtos_diversos.dart' as produtos;
...
void main() async {
  ...
  // Configurar SQLite para diferentes plataformas
  if (kIsWeb) {
    // Para web, usa IndexedDB através do sqflite_ffi_web
  ...
  // Inicializar notificações (apenas se não for web)
  if (!kIsWeb) {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/fornecedores': (context) =>
            const fornecedores.FornecedoresMedicamentos(),
        '/produtos': (context) => const produtos.ProdutosDiversos(),
      },
    );
  }
}
